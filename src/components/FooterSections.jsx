            ...
            <footer className="footer footer-center text-white-content rounded mt-20 p-10">
                <nav>
                    <div className="grid grid-flow-col gap-4">
                        <a href="https://www.youtube.com/@KennOnirom/videos" target="_blank" rel="noopener noreferrer">
                            <svg
                        ...
                        <a href="https://andreikennethmoreno.github.io/ReactJsPortfolio/" target="_blank" rel="noopener noreferrer">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="26"  
                                height="26" 
